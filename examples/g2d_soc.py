...
ensure_file("websocket.html", "https://raw.githubusercontent.com/tomamic/fondinfo/master/examples/websocket.html")
...
def init_canvas(size: (int, int)) -> None:
    if _server == None:
        ...
        webbrowser.open("http://localhost:8008/websocket.html", new=0)
        while _socket == None:
            time.sleep(0.1)
    '''
